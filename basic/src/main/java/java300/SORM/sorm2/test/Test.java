package java300.SORM.sorm2.test;

import java.util.List;

import java300.SORM.sorm2.sorm.core.Query;
import java300.SORM.sorm2.sorm.core.QueryFactory;
import java300.SORM.sorm2.vo.EmpVO;
